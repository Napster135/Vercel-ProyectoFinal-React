...
export const Checkout = () => {
    ...
    if(Object.fromEntries(datForm).email !== Object.fromEntries(datForm).repEmail) return false    
    ...
    toast.success(`¡Muchas Gracias por Elegirnos!, tu orden de compra es : ${ordenCompra.id
    } por un valor de $ ${new Intl.NumberFormat('de-DE').format(totalPrice())} se realizo con exito `)
    emptyCart()
    e.target.reset()
    navigate("/")
    })
